...
const routes: Array<RouteRecordRaw> = [
  ...
  {path: '/login',component: () => import ('@/public/Login.vue')},
  {
    ...
    children: [
      ...
      {path: '/dashboard', component: () => import('@/secure/dashboard/Dashboard.vue')},
      {path: '/profile', component: () => import('@/secure/profile/Profile.vue')},
      ...
      {path: '/products/:id/edit', component: () => import('@/secure/products/ProductsEdit.vue')},
      {path: '/orders', component: () => import('@/secure/orders/Orders.vue')},
      {path: '/orders/:id', component: () => import('@/secure/orders/OrderItems.vue')},
    ]
  },
]
